models:
	...
	java -jar third_party/openapi/swagger-codegen-cli-3.0.20.jar generate -i swagger.yaml -l kotlin-server --additional-properties sourceFolder="" -D models -o rewinder/app/src/main/java
